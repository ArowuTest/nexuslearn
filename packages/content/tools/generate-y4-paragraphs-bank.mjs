...
function candidate({ id, format, blueprint, strand, stage, item, prompt, answer, choices, hints, explanation, purpose, misconception, retrieval = false }) {
