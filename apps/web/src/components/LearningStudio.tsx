...
export default function LearningStudio({
  ...
  return (
    <>
      ...
      {isOperationModel && <OperationModelBoard key={question.id} question={question} input={input} onChoose={onChoose} />}
