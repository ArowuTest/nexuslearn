...
function CoordinateBoard({ question, input, onChoose }: { question: StudioQuestion; input: string; onChoose: (value: string) => void }) {
  ...
  return (
    <section className="studio-workspace-panel" aria-label="Coordinate plotter">
      <p className="studio-step-label">Coordinate explorer</p>
...
function CoordinateMap({ question }: { question: StudioQuestion }) {
  ...
  return (
    <section className="studio-workspace-panel" aria-label={format === 'coordinate-read' ? 'Coordinate reading map' : 'Coordinate translation map'}>
      <p className="studio-step-label">{format === 'coordinate-read' ? 'Treasure map' : 'Gem mover'}</p>
...
function MethodChoiceBoard({ question, input, onChoose }: { question: StudioQuestion; input: string; onChoose: (value: string) => void }) {
  ...
  return <section className="studio-workspace-panel" aria-label="Calculation strategy board">
    <p className="studio-step-label">Number workshop</p>
...
function ErrorAnalysisBoard({ question, input, onChoose }: { question: StudioQuestion; input: string; onChoose: (value: string) => void }) {
  ...
  return <section className="studio-workspace-panel" aria-label="Worked example error analysis">
    <p className="studio-step-label">Calculation detective</p>
...
function FunctionMachineBoard({ question, input, onChoose, onSubmit }: { question: StudioQuestion; input: string; onChoose: (value: string) => void; onSubmit: () => void }) {
  ...
  return <section className="studio-workspace-panel" aria-label="Function machine board">
    <p className="studio-step-label">Function machine</p>
    ...
    <button type="button" onClick={onSubmit} disabled={!input} className="btn-pop studio-check-answer" aria-label="Submit function machine answer">Send answer</button>
  </section>;
}
...
function NumberModelBoard({ question, input, onChoose, onSubmit }: { question: StudioQuestion; input: string; onChoose: (value: string) => void; onSubmit: () => void }) {
  ...
  return <section className="studio-workspace-panel" aria-label={title}>
    ...
    <button type="button" onClick={onSubmit} disabled={!input} className="btn-pop studio-check-answer" aria-label="Submit number model answer">Send answer</button>
  </section>;
}
function FactFamilyBoard({ question, input, onChoose, onSubmit }: { question: StudioQuestion; input: string; onChoose: (value: string) => void; onSubmit: () => void }) {
  ...
  return <section className="studio-workspace-panel" aria-label="Choice board">
    <p className="studio-step-label">Fact workshop</p>
    ...
    <button type="button" onClick={onSubmit} disabled={!selected.length || (multi && selected.length !== selectCount)} className="btn-pop studio-check-answer" aria-label="Submit fact family">Send answer</button>
  </section>;
}
function FractionWallBoard({ question, input, onChoose, onSubmit }: { question: StudioQuestion; input: string; onChoose: (value: string) => void; onSubmit: () => void }) {
  ...
  return <section className="studio-workspace-panel" aria-label="Fraction wall board">
    <p className="studio-step-label">Fraction wall</p>
...
function RatioScaleBoard({ question, input, onChoose, onSubmit }: { question: StudioQuestion; input: string; onChoose: (value: string) => void; onSubmit: () => void }) {
  ...
  return <section className="studio-workspace-panel" aria-label="Ratio scale board">
    <p className="studio-step-label">Ratio scaling lab</p>
    ...
    <button type="button" onClick={onSubmit} disabled={selected.length !== 2 || selected.some((value) => !Number.isFinite(value))} className="btn-pop studio-check-answer" aria-label="Submit ratio scale answer">Send answer</button>
  </section>;
}
...
function PatternSortBoard({ question, input, onChoose, onSubmit }: { question: StudioQuestion; input: string; onChoose: (value: string) => void; onSubmit: () => void }) {
  ...
  return <section className="studio-workspace-panel" aria-label="Spelling pattern sorter">
    <p className="studio-step-label">Spelling pattern sorter</p>
    ...
    <button type="button" onClick={onSubmit} disabled={!complete} className="btn-pop studio-check-answer" aria-label="Submit spelling pattern sort">Send answer</button>
  </section>;
}
