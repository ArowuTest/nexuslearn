...
const limits = {
  ...
  // The assistance-evidence UI adds a small, deliberate amount of reporting
  // metadata. Route, largest-file, CSS and public-asset limits stay unchanged.
  aggregateJavaScript: 1_406_000,
