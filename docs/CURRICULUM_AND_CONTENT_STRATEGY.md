...
`packages/content/roadmaps/y1-y7-core-pack-roadmap.json` is a 56-pack product
...
map conservatively to 59 areas (66%), leaving 31 missing area packs:
...
maps every authored pack to the 90 declared areas, publishes all 31 missing
...
curriculum-area report now owns the real breadth queue: 31 missing packs. The
...
clauses and properties of materials for Year 5. The next wave closes the
remaining Year 3/5 English and Science gaps while restarting Year 1 breadth.

Current Phase 3 content status:

- Roadmapped core packs: 56
- Authored rich proof packs: 56
- Remaining roadmapped packs: 0
- Declared core curriculum areas: 90
- Areas with at least one authored pack: 59 (66%)
- Missing curriculum-area packs: 31
- Planned mature-bank variants across authored packs: 83,930
...
1. Keep the 56-pack core roadmap green while adding the next balanced roadmap
